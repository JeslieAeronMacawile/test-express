...
import styles from './CatgeoryStyle'
...
const Category = () => {
    ...
    const { categoryData, getCategoryError, getCategory, postCategory, categoryPostResponse } = useLibrary();
    ...
    useEffect(() => {
        if (categoryPostResponse != null || categoryPostResponse != undefined) {
            postCategory({}, true)
            getCategory(true)
        }
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: "column" }}>
                    <div>
                        <Typography style={classes.typoTitle}>
                            {modalAction == "ADD" ? "Add Category" : "Manage Category"}
                        </Typography>
                    </div>
                    ...
                    <div style={{ display: "flex", flexDirection: 'column', justifyContent: 'end', alignItems: 'end', width: '100%' }}>
                        <div style={{ display: "flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                            ...
                            {modalAction == "DELETE" ?
                                ...
                                <N8Components.TextField style={{ width: '60%' }} label="Name" setValue={setcategoryName} />}
